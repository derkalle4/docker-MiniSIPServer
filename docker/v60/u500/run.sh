...
if [ ! -f "/opt/sipserver/minisipserver-cli" ]; then
  ...
  wget https://www.myvoipapp.com/download/mss_v60/amd64/mss_v60_u500_amd64.deb -O /tmp/mss_v60_u500_amd64.deb

  echo "Installing MiniSIPServer package..."
  dpkg --install /tmp/mss_v60_u500_amd64.deb
